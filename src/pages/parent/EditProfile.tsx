...
const ParentEditProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    address: '123 Parent Lane, Education City, EC 12345',
    childName: 'Child Name',
    emergencyContact: 'Emergency Contact Name',
    emergencyPhone: '+1 (555) 555-5555',
    bio: 'Dedicated parent supporting their child\'s educational journey.'
  });
          ...
          <CardHeader className="text-center">
            <div className="flex justify-center mb-4">
              <Avatar className="h-24 w-24">
                <AvatarFallback className="text-2xl bg-yellow-600 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setProfileData(prev => ({ ...prev, childName: e.target.value }))}
                  disabled={!isEditing}
                />
              </div>
            </div>
